...
rolling_window_results_month_2021_2024_sp500_test <- mega_rol_pred_parallel(returns150[1:500,], 252, 21, rf=risk_free[1:500], max_factors = 10, min_returns = 0.01)
rolling_window_results_month_2021_2024_sp500_test$stats
